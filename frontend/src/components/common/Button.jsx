const Button = ({ children, onClick, type = 'button', variant = 'primary', disabled = false }) => {
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-teal-600 via-teal-500 to-emerald-500 hover:from-teal-500 hover:to-emerald-400 text-white shadow-md shadow-teal-500/20 hover:shadow-lg hover:shadow-teal-500/30 focus:ring-teal-400',
